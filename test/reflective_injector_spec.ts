...
import {Inject, Injectable, Injector, Optional, Provider, ReflectiveInjector, ReflectiveKey, Self, forwardRef} from '../lib/index';
import {
  ReflectiveInjectorDynamicStrategy,
  ReflectiveInjectorInlineStrategy,
  ReflectiveInjector_,
  ReflectiveProtoInjector
} from '../lib/reflective_injector';
...
[{strategy: 'inline', providers: [], strategyClass: ReflectiveInjectorInlineStrategy}, {
  ...
  describe(`injector ${context['strategy']}`, () => {
    it('should use the right strategy', () => {
      ...
      expect(injector.internalStrategy instanceof context['strategyClass']).toBe(true);
    });
    ...
    it('should handle forwardRef in useExisting', () => {
      ...
      expect(injector.get('aliasedEngine') instanceof Engine).toBe(true);
    });
  ...
  describe('child', () => {
    ...
    it('should not use the child providers when resolving the dependencies of a parent provider',
       () => {
         ...
         expect(carFromChild.engine instanceof Engine).toBe(true);
       });
    ...
    it('should create new instance in a child injector', () => {
      ...
      expect(engineFromChild instanceof TurboEngine).toBe(true);
    });
  ...
  describe('depedency resolution', () => {
    describe('@Self()', () => {
      it('should return a dependency from self', () => {
        ...
        expect(inj.get(Car) instanceof Car).toBe(true);
      });
